...
const COMMON_PROPERTIES = {
  ...
  optionItems: 'option-items-editor',
  column:"column-items-editor"
}
...
const ADVANCED_PROPERTIES = {
  ...
  rows: 'rows-editor',
  isCheckBox: 'isCheckBox-editor', //hzq
  defaultExpandAll: 'defaultExpandAll-editor', //hzq
  highlightCurrent: 'highlightCurrent-editor', //hzq
  ...
  scanCode: 'scanCode-editor',
  scanCodeSkip: 'scanCodeSkip-editor',
