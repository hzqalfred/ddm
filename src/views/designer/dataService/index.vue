<template>
  <div class="content-table-wrap">
        ...
        <template #header>
          <div class="card-header">
            ...
            <el-input
              ...
              placeholder="请输入关键词"
              clearable
              @keydown.enter="refreshDataSrvTree"
    ...
    <div class="table-wrap">
      ...
      <el-divider />
      <div style="margin:10px 0px;">
        <el-button type="primary" :icon="Plus" @click="addServiceEventRow"
          >新增方法</el-button
        >
        <el-button
          type="danger"
        ...
        <el-table-column fixed="right" width="250" align="left" label="操作">
          <template #default="scope">
            <el-button
              ...
              :icon="List"
              link
              @click="editServiceEventRow(scope.row)"
              >设计业务</el-button
            >
          </template>
        </el-table-column>
  ...
  >
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item label="数据对象编码" prop="dataSvCode">
            <el-input
              style="width: 100%;"
              v-model="translateForm.dataSvCode"
              placeholder="请输入数据对象编码"
            />
          </el-form-item>
        </el-col>
        <el-col :span="24">
    ...
    <template #footer>
      <div class="dialog-footer">
        ...
        <el-button type="primary" @click="translateSubmit"
          >生成数据服务</el-button
        >
      </div>
    </template>
  ...
  <ServiceEventEdit
    ref="serviceEventEditRef"
    :optType="optType"
    :moduleDetails="moduleDetails"
    :moduleData="moduleData"
    @refreshTableData="loadTableData"
  ></ServiceEventEdit>
</template>
...
const editRules = reactive({
  ...
  dbSource: [{ required: true, message: "请填写数据源名称", trigger: "blur" }],
});
...
const refreshDataSrvTree = () => {
  listService({ q__kwd: queryKeyWord.value, ...moduleData.value }).then(
    (res) => {
