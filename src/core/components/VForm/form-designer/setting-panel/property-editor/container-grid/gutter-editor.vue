  ...
  <div>
    ...
    <el-form-item label-width="0">
      <li v-for="(colItem, colIdx) in selectedWidget.cols" :key="colIdx" class="col-item">
        <span class="col-span-title">{{ colItem?.widgetList[0]?.options?.label }} {{ i18nt('designer.setting.cellWidth') }}</span>
        ...
        <vxe-button size="mini" status="error" icon="vxe-icon-delete" circle @click="deleteCol(selectedWidget, colIdx)" style="left: 5px;"></vxe-button>
      </li>
    </el-form-item>
  </div>
</template>
