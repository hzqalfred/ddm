...
<template>
  ...
  >
  <vxe-checkbox-group  ref="checkboxGroupRef" 
    v-model="field.options.vmodel"
    :max="field.options.commax"
    :checkboxType="field.options.checkboxType"
    :style="{
      display: 'flex', 
    ...
    @change="handleChangeEvent">
      <vxe-checkbox
        v-for="(checkbox, index) in field.checkboxs" 
        :name="checkbox.options.name" 
        :label="checkbox.options.label"
        :size="field.options.comsize" 
        :disabled="checkbox.options.disabled" 
        :style="{ display: checkbox.options.hidden ? 'none' : 'block' }"
      >
