<template>
  <div style="margin-top: 40px;padding: 0 40px;">
    ...
    <div style="margin-top: -60px; ">
      <vxe-tip  status="primary">字段明细</vxe-tip>
      <vxe-table
        border
        height="300"
        :data="tableDataC"
      >
        ...
        <vxe-column field="columnRemark" title="字段描述"></vxe-column>
        <vxe-column field="columnLength" title="字段长度"></vxe-column>
        <vxe-column field="hasPk" align="center" width="80" title="主键？">
          <template #default="scope">
            {{ scope.row.hasNull === "1" ? "是" : "否" }}
          </template>
        </vxe-column>
        <vxe-column field="hasNull" align="center" width="80" title="非空">
          <template #default="scope">
            {{ scope.row.hasNull === "1" ? "是" : "否" }}
          </template>
        </vxe-column>
        <vxe-column field="defaultValue" title="默认值"></vxe-column>
      </vxe-table>
    </div>
    <div>
