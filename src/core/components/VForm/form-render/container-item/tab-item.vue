<template>
  <container-item-wrapper :widget="widget">
    <div :key="widget.id" class="tab-container" v-show="!widget.options.hidden">
      <vxe-tabs v-model="activeTabName" :type="widget.options.tabType" :ref="widget.id" :class="[customClass]" :padding="widget.options.tabPadding" :height="widget.options.tabHeight">
      <vxe-tab-pane 
