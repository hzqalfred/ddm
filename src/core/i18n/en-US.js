export default {
  ...
  designer: {
    ...
    widgetLabel: {
      ...
      'html-text': 'HTML',
      button: 'Button',
      buttongroup: 'ButtonGroup', //hzq
      tree: 'Tree', //hzq
      eltable: 'Table', //hzq
      'grid-table': 'Table', //hzq
      query: 'Query', //hzq
      pagination: 'Pagination', //hzq
    ...
    setting: {
      ...
      showModal: 'Show Modal', //hzq
      showClose: 'Show Close', //hzq
      closeOnClickModal: 'Close On Click Modal', //hzq
      closeOnPressEscape: 'Close On Press Escape', //hzq
      center: 'Center', //hzq
      hideComfirm: 'Hide Comfirm Button', //hzq
      hideCancel: 'Hide Cancel Button', //hzq
      comfirmButtonText: 'Comfirm Button Text', //hzq
      cancelButtonText: 'Cancel Button Text', //hzq
      columns: 'Columns', //hzq
      selectabled: 'Multiple Select', //hzq
      highlightCurrentRow: 'Single Select', //hzq
      isCheckBox: 'Selectable', //hzq
      defaultExpandAll: 'Expand All', //hzq
      highlightCurrent: 'Highlight Current', //hzq
      stripe: 'stripe', //hzq
      maxHeight: 'Max Height', //hzq
      dialogWidth: 'Dialog Width (px/%)', //hzq
      fullScreen: 'Full Screen', //hzq
      showIndex: 'Show Index', //hzq
      pageList: 'Page List', //hzq
      pageUnit: 'Page Unit', //hzq
      pageAlign: 'Align', //hzq
      isDraggable: 'isDraggable', //hzq
      isFilter: 'Show Filter Input' //hzq
    }
  }
}
