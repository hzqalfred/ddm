<template>
    ...
    >
      ...
      :subtitle="field.options.subtitle"
      :align="field.options.align"
      :lineColor="field.options.lineColor"
      :titleColor="field.options.titleColor"
      :icon="field.options.lefticon"
      :styleType="field.options.styleType"
    />
    </static-content-wrapper>
  </template>
